...
extern "C"
{
	...
	{
		return FacadeModele::obtenirInstance()->obtenirAutorisationEntreesUtilisateur();
	}
	...
	{
		FacadeModele::obtenirInstance()->assignerAutorisationEntreesUtilisateur(autorisation);
	}
	...
	{
		bool autoriserInput = FacadeModele::obtenirInstance()->obtenirAutorisationEntreesUtilisateur();
