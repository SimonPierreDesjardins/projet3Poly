...
bool NoeudTeleporteur::collisionTeleporteur()
{
	...
	for (unsigned int i = 0; i < FacadeModele::obtenirInstance()->obtenirArbreRenduINF2990()->chercher("table")->obtenirNombreEnfants() -1; i++) //on v�rifie le cercle englobant des autres t�l�porteurs afin d'�viter d'avoir un t�l�porter dans ceux-ci
	{
