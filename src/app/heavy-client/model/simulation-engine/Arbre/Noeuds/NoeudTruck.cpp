...
const glm::dvec3 NoeudTruck::POSITION_CAPTEUR_DISTANCE_GAUCHE = { 3.47, 1.85, 5.0 };
const glm::dvec3 NoeudTruck::POSITION_CAPTEUR_DISTANCE_CENTRE = { 4.2695, 0.1, 5.0 };
const glm::dvec3 NoeudTruck::POSITION_CAPTEUR_DISTANCE_DROITE = { 3.60, -1.80, 5.0 };

const double NoeudTruck::ANGLE_RELATIF_CAPTEUR_DISTANCE_DROITE{ -45.0 };
const double NoeudTruck::ANGLE_RELATIF_CAPTEUR_DISTANCE_CENTRE{ 0.0 };
const double NoeudTruck::ANGLE_RELATIF_CAPTEUR_DISTANCE_GAUCHE{ 45.0 };
...
////////////////////////////////////////////////////////////////////////
//
// @fn NoeudTruck::NoeudTruck(uint32_t id, const std::string& typeNoeud)
//
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::positionDepart()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::accepterVisiteur(VisiteurAbstrait* visiteur)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::accepterVisiteur(VisiteurAbstrait* visiteur)
{
}

////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::animer(float dt)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::animer(float dt)
{
...
////////////////////////////////////////////////////////////////////////
///
/// void NoeudTruck::calculerComposantesVitesseCourante(glm::dvec3& vitesseTranslation, double& vitesseAngulaire) const
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::calculerComposantesCollision(const glm::dvec3& normale, glm::dvec3& vitesseTranslationCollision,
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::verifierCollision(NoeudPoteau* poteau)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudTruck::verifierCollision(NoeudPoteau* poteau)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::verifierCollision(NoeudMur* noeud)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudTruck::verifierCollision(NoeudMur* mur)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::verifierCollision(NoeudTable* noeud)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudTruck::verifierCollision(NoeudTable* table)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::mettreAJourCapteurs()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::mettreAJourCapteurs()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::mettreAJourPosition(const float& dt)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::mettreAJourPosition(const float& dt)
{
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::reinitialiserPosition()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::mettreAJourRectangleEnglobant()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::mettreAJourFormeEnglobante()
{
	positionCourante_ = positionRelative_;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::effectuerCollision()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::effectuerCollision(const double& dt)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::positionnerRoues()
///
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::assignerMode(int mode)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudTruck::assignerMode(int mode)
{
	mode_ = mode;
}
