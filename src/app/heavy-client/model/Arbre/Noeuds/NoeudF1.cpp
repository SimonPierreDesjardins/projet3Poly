...
const glm::dvec3 NoeudF1::POSITION_CAPTEUR_DISTANCE_GAUCHE = { 3.47, 1.85, 5.0 };
const glm::dvec3 NoeudF1::POSITION_CAPTEUR_DISTANCE_CENTRE = { 4.2695, 0.1, 5.0 };
const glm::dvec3 NoeudF1::POSITION_CAPTEUR_DISTANCE_DROITE = { 3.60, -1.80, 5.0 };

const double NoeudF1::ANGLE_RELATIF_CAPTEUR_DISTANCE_DROITE{ -45.0 };
const double NoeudF1::ANGLE_RELATIF_CAPTEUR_DISTANCE_CENTRE{ 0.0 };
const double NoeudF1::ANGLE_RELATIF_CAPTEUR_DISTANCE_GAUCHE{ 45.0 };
...
///
////////////////////////////////////////////////////////////////////////
NoeudF1::NoeudF1(const std::string& typeNoeud)
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::accepterVisiteur(VisiteurAbstrait* visiteur)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::accepterVisiteur(VisiteurAbstrait* visiteur)
{
}

////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::animer(float dt)
///
...
////////////////////////////////////////////////////////////////////////
///
/// void NoeudF1::calculerComposantesVitesseCourante(glm::dvec3& vitesseTranslation, double& vitesseAngulaire) const
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::calculerComposantesCollision(const glm::dvec3& normale, glm::dvec3& vitesseTranslationCollision,
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::verifierCollision(NoeudPoteau* poteau)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudF1::verifierCollision(NoeudPoteau* poteau)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::verifierCollision(NoeudMur* noeud)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudF1::verifierCollision(NoeudMur* mur)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::verifierCollision(NoeudTable* noeud)
///
...
///
////////////////////////////////////////////////////////////////////////
bool NoeudF1::verifierCollision(NoeudTable* table)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::mettreAJourCapteurs()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::mettreAJourCapteurs()
{
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::mettreAJourPosition(const float& dt)
{
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::reinitialiserPosition()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::mettreAJourRectangleEnglobant()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::mettreAJourFormeEnglobante()
{
    positionCourante_ = positionRelative_;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::effectuerCollision()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::effectuerCollision(const double& dt)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudF1::assignerMode(int mode)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudF1::assignerMode(int mode)
{
	mode_ = mode;
}
