...
/// @date 2017-02-22
///////////////////////////////////////////////////////////////////////////
class NoeudTruck : public NoeudComposite
{
public:
	...
	NoeudTruck(const std::string& typeNoeud);
	/// Destructeur.
	~NoeudTruck();
...
////////////////////////////////////////////////////////////////////////
///
/// @fn inline SuiveurLigne* NoeudTruck::obtenirSuiveurLigne()
///
...
///
////////////////////////////////////////////////////////////////////////
inline SuiveurLigne* NoeudTruck::obtenirSuiveurLigne()
{
...
///
////////////////////////////////////////////////////////////////////////
inline NoeudTruck::ConteneurCapteursDistance* NoeudTruck::obtenirCapteursDistance()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::obtenirVitesseDroite() const
///
...
///
////////////////////////////////////////////////////////////////////////
inline float NoeudTruck::obtenirVitesseDroite() const
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::obtenirVitesseGauche() const
///
...
///
////////////////////////////////////////////////////////////////////////
inline float NoeudTruck::obtenirVitesseGauche() const
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::assignerVitesseDroite() const
///
...
///
////////////////////////////////////////////////////////////////////////
inline void NoeudTruck::assignerVitesseDroite(float vitesse)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::assignerVitesseGauche() const
///
...
///
////////////////////////////////////////////////////////////////////////
inline void NoeudTruck::assignerVitesseGauche(float vitesse)
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudTruck::assignerVitesseRotation() const
///
...
///
////////////////////////////////////////////////////////////////////////
inline void NoeudTruck::assignerVitesseRotation(float vitesse)
{
	vitesseRotation_ = vitesse;
}

inline void NoeudTruck::assignerEstEnCollision(bool collision)
{
	estEnCollision_ = collision;
	rectangleEnglobant_.assignerEnCollision(collision);
}

inline void NoeudTruck::assignerMutex(std::mutex* mutex)
{
