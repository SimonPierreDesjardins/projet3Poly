...
namespace opengl{
	...
	///
	////////////////////////////////////////////////////////////////////////
	void VBO::dessiner(modele::Noeud const& noeud, unsigned int& bufferIndex) const
	{
		...
		for (auto const& mesh : noeud.obtenirMeshes())
		{
			...
			if(noeud.obtenirNom() == "Body" || noeud.obtenirNom() == "Back_Bumper" || noeud.obtenirNom() == "Front_Bumper" || noeud.obtenirNom() == "Cube")
